...
The To-do App by Johann is a simple app on Python + Tkinter that uses a simple table as the to-do list
You can create, delete and edit, thje nam, duedate, priority, and status
You can also save and load to-do lists in .json format
